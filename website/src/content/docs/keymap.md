---
title: Keymap
description: Default key bindings for every Mitos mode.
---
...
Please refer to the relevant sections for detailed explanations about [surround](../surround/) and [textobjects](../textobjects/).
...
[Smart tab]: ../editor/#editorsmart-tab-section
...
See the documentation page on [pickers](../pickers/) for more info.
