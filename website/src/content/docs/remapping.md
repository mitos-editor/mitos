---
title: Key remapping
description: Define custom key bindings, minor modes, and macros.
---
...
* Static commands: commands like `move_char_right` which are usually bound to
  ...
  available in the [Keymap](../keymap/) documentation and in the source code
...
* Typable commands: commands that can be executed from command mode (`:`), for
  example `:write!`. See the [Commands](../commands/) documentation for a
