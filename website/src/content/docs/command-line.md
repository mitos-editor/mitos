---
title: Command line
description: Run commands, use expansions, and compose shell-aware workflows.
---
...
The command line is used for executing [typable commands](../commands/#typable-commands) like `:write` or `:quit`. Press `:` to activate the command line.
