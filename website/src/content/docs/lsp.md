...
description: Use and configure Mitos' built-in Language Server Protocol support.
---
...
programs you install yourself: the [language support](../lang-support/) page
...
Most features are bound by default (see the [keymap](../keymap/)); the relevant
...
The [`[editor.lsp]`](../editor/#editorlsp-section) section of `config.toml`
...
[`[editor.inline-diagnostics]`](../editor/#editorinline-diagnostics-section).
...
[Language Server configuration](../languages/#language-server-configuration)). A
language may use [several servers](../languages/#configuring-language-servers-for-a-language):
