---
title: Languages
description: Configure languages, language servers, formatters, and grammars.
---
...
2. In your [configuration directory](../configuration/). This overrides values
...
| `soft-wrap`           | [editor.softwrap](../editor/#editorsoft-wrap-section)
...
| `word-completion`     | Overrides the [`editor.word-completion`](../editor/#editorword-completion-section) configuration for the language. |
...
[Command line expansions](../command-line/#expansions) are supported in the arguments
