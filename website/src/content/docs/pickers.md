---
title: Pickers
description: Find files, symbols, commands, and more with interactive pickers.
---

## Using pickers

Mitos has a variety of pickers, which are interactive windows used to select various kinds of items. These include a file picker, global search picker, and more. Most pickers are accessed via keybindings in [space mode](../keymap/#space-mode). Pickers have their own [keymap](../keymap/#picker) for navigation.
