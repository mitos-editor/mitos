---
title: Themes
description: Select, create, and customize Mitos color themes.
---

## Themes

To use a theme add `theme = "<name>"` to the top of your [`config.toml`](../configuration/) file, or select it during runtime using `:theme <name>`.
