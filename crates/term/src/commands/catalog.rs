...
impl MappableCommand {
    #[rustfmt::skip]
    static_commands!(
        no_op => super::application::no_op, "Do nothing",
        ...
        move_parent_node_end => super::syntax::move_parent_node_end, "Move to end of the parent node",
        move_parent_node_start => super::syntax::move_parent_node_start, "Move to beginning of the parent node",
        ...
        extend_parent_node_end => super::syntax::extend_parent_node_end, "Extend to end of the parent node",
        extend_parent_node_start => super::syntax::extend_parent_node_start, "Extend to beginning of the parent node",
        ...
        search => super::search::search, "Search for regex pattern",
        rsearch => super::search::rsearch, "Reverse search for regex pattern",
        search_next => super::search::search_next, "Select next search match",
        search_prev => super::search::search_prev, "Select previous search match",
        extend_search_next => super::search::extend_search_next, "Add next search match to selection",
        extend_search_prev => super::search::extend_search_prev, "Add previous search match to selection",
        search_selection => super::search::search_selection, "Use current selection as search pattern",
        search_selection_detect_word_boundaries => super::search::search_selection_detect_word_boundaries, "Use current selection as the search pattern, automatically wrapping with `\\b` on word boundaries",
        make_search_word_bounded => super::search::make_search_word_bounded, "Modify current search to make it word bounded",
        global_search => super::search::global_search, "Global search in workspace folder",
        ...
        file_picker => super::files::file_picker, "Open file picker",
        file_picker_in_current_buffer_directory => super::files::file_picker_in_current_buffer_directory, "Open file picker at current buffer's directory",
        file_picker_in_current_directory => super::files::file_picker_in_current_directory, "Open file picker at current working directory",
        file_explorer => super::files::file_explorer, "Open file explorer in workspace root",
        file_explorer_in_current_buffer_directory => super::files::file_explorer_in_current_buffer_directory, "Open file explorer at current buffer's directory",
        file_explorer_in_current_directory => super::files::file_explorer_in_current_directory, "Open file explorer at current working directory",
        code_action => super::lsp::code_action, "Perform code action",
        buffer_picker => super::buffers::buffer_picker, "Open buffer picker",
        jumplist_picker => super::navigation::jumplist_picker, "Open jumplist picker",
        quicklist_picker => super::quicklist::quicklist_picker, "Open quicklist picker",
        ...
        lsp_or_syntax_workspace_symbol_picker => super::symbols::lsp_or_syntax_workspace_symbol_picker, "Open workspace symbol picker from LSP or syntax information",
        diagnostics_picker => super::diagnostics::diagnostics_picker, "Open diagnostic picker",
        workspace_diagnostics_picker => super::diagnostics::workspace_diagnostics_picker, "Open workspace diagnostic picker",
        last_picker => super::palette::last_picker, "Open last picker",
        ...
        goto_file_start => super::navigation::goto_file_start, "Goto line number `<n>` else file start",
        goto_file_end => super::navigation::goto_file_end, "Goto file end",
        extend_to_file_start => super::navigation::extend_to_file_start, "Extend to line number `<n>` else file start",
        extend_to_file_end => super::navigation::extend_to_file_end, "Extend to file end",
        goto_file => super::files::goto_file, "Goto files/URLs in selections",
        goto_file_hsplit => super::files::goto_file_hsplit, "Goto files in selections (hsplit)",
        goto_file_vsplit => super::files::goto_file_vsplit, "Goto files in selections (vsplit)",
        ...
        goto_last_accessed_file => super::navigation::goto_last_accessed_file, "Goto last accessed file",
        goto_last_modified_file => super::navigation::goto_last_modified_file, "Goto last modified file",
        goto_last_modification => super::navigation::goto_last_modification, "Goto last modification",
        goto_line => super::navigation::goto_line, "Goto line",
        goto_last_line => super::navigation::goto_last_line, "Goto last line",
        extend_to_last_line => super::navigation::extend_to_last_line, "Extend to last line",
        goto_first_diag => super::diagnostics::goto_first_diag, "Goto first diagnostic",
        goto_last_diag => super::diagnostics::goto_last_diag, "Goto last diagnostic",
        goto_next_diag => super::diagnostics::goto_next_diag, "Goto next diagnostic",
        goto_prev_diag => super::diagnostics::goto_prev_diag, "Goto previous diagnostic",
        goto_next_spelling => super::spelling::goto_next_spelling, "Goto next spelling finding",
        goto_prev_spelling => super::spelling::goto_prev_spelling, "Goto previous spelling finding",
        goto_next_quicklist => super::quicklist::goto_next_quicklist, "Goto next quicklist entry",
        goto_prev_quicklist => super::quicklist::goto_prev_quicklist, "Goto previous quicklist entry",
        goto_next_file_quicklist => super::quicklist::goto_next_file_quicklist, "Goto next quicklist entry in current file",
        goto_prev_file_quicklist => super::quicklist::goto_prev_file_quicklist, "Goto previous quicklist entry in current file",
        goto_next_change => super::vcs::goto_next_change, "Goto next change",
        goto_prev_change => super::vcs::goto_prev_change, "Goto previous change",
        goto_first_change => super::vcs::goto_first_change, "Goto first change",
        goto_last_change => super::vcs::goto_last_change, "Goto last change",
        goto_line_start => super::movement::goto_line_start, "Goto line start",
        goto_line_end => super::movement::goto_line_end, "Goto line end",
        goto_column => super::navigation::goto_column, "Goto column",
        extend_to_column => super::navigation::extend_to_column, "Extend to column",
        goto_next_buffer => super::navigation::goto_next_buffer, "Goto next buffer",
        goto_previous_buffer => super::navigation::goto_previous_buffer, "Goto previous buffer",
        ...
        completion => super::completion::completion, "Invoke completion popup",
        ...
        expand_selection => super::syntax::expand_selection, "Expand selection to parent syntax node",
        shrink_selection => super::syntax::shrink_selection, "Shrink selection to previously expanded syntax node",
        select_next_sibling => super::syntax::select_next_sibling, "Select next sibling in the syntax tree",
        select_prev_sibling => super::syntax::select_prev_sibling, "Select previous sibling the in syntax tree",
        select_all_siblings => super::syntax::select_all_siblings, "Select all siblings of the current node",
        select_all_children => super::syntax::select_all_children, "Select all children of the current node",
        jump_forward => super::navigation::jump_forward, "Jump forward on jumplist",
        jump_backward => super::navigation::jump_backward, "Jump backward on jumplist",
        save_selection => super::navigation::save_selection, "Save current selection to jumplist",
        jump_view_right => super::windows::jump_view_right, "Jump to right split",
        jump_view_left => super::windows::jump_view_left, "Jump to left split",
        jump_view_up => super::windows::jump_view_up, "Jump to split above",
        jump_view_down => super::windows::jump_view_down, "Jump to split below",
        swap_view_right => super::windows::swap_view_right, "Swap with right split",
        swap_view_left => super::windows::swap_view_left, "Swap with left split",
        swap_view_up => super::windows::swap_view_up, "Swap with split above",
        swap_view_down => super::windows::swap_view_down, "Swap with split below",
        transpose_view => super::windows::transpose_view, "Transpose splits",
        rotate_view => super::windows::rotate_view, "Goto next window",
        rotate_view_reverse => super::windows::rotate_view_reverse, "Goto previous window",
        hsplit => super::windows::hsplit, "Horizontal bottom split",
        hsplit_new => super::windows::hsplit_new, "Horizontal bottom split scratch buffer",
        vsplit => super::windows::vsplit, "Vertical right split",
        vsplit_new => super::windows::vsplit_new, "Vertical right split scratch buffer",
        wclose => super::windows::wclose, "Close window",
        wonly => super::windows::wonly, "Close windows except current",
        ...
        match_brackets => super::syntax::match_brackets, "Goto matching bracket",
        ...
        select_textobject_around => super::textobjects::select_textobject_around, "Select around object",
        select_textobject_inner => super::textobjects::select_textobject_inner, "Select inside object",
        select_all_textobjects_around => super::textobjects::select_all_textobjects_around, "Select all textobjects around selections",
        select_all_textobjects_inner => super::textobjects::select_all_textobjects_inner, "Select all textobjects inside selections",
        goto_next_function => super::syntax::goto_next_function, "Goto next function",
        goto_prev_function => super::syntax::goto_prev_function, "Goto previous function",
        goto_next_class => super::syntax::goto_next_class, "Goto next type definition",
        goto_prev_class => super::syntax::goto_prev_class, "Goto previous type definition",
        goto_next_parameter => super::syntax::goto_next_parameter, "Goto next parameter",
        goto_prev_parameter => super::syntax::goto_prev_parameter, "Goto previous parameter",
        goto_next_comment => super::syntax::goto_next_comment, "Goto next comment",
        goto_prev_comment => super::syntax::goto_prev_comment, "Goto previous comment",
        goto_next_test => super::syntax::goto_next_test, "Goto next test",
        goto_prev_test => super::syntax::goto_prev_test, "Goto previous test",
        goto_next_xml_element => super::syntax::goto_next_xml_element, "Goto next (X)HTML element",
        goto_prev_xml_element => super::syntax::goto_prev_xml_element, "Goto previous (X)HTML element",
        goto_next_entry => super::syntax::goto_next_entry, "Goto next pairing",
        goto_prev_entry => super::syntax::goto_prev_entry, "Goto previous pairing",
        ...
        suspend => super::application::suspend, "Suspend and return to shell",
        ...
        record_macro => super::macros::record_macro, "Record macro",
        replay_macro => super::macros::replay_macro, "Replay macro",
        command_palette => super::palette::command_palette, "Open command palette",
        goto_word => super::navigation::goto_word, "Jump to a two-character label",
        extend_to_word => super::navigation::extend_to_word, "Extend to a two-character label",
        goto_next_tabstop => super::snippets::goto_next_tabstop, "Goto next snippet placeholder",
        goto_prev_tabstop => super::snippets::goto_prev_tabstop, "Goto next snippet placeholder",
...
pub const TYPABLE_COMMAND_LIST: &[TypableCommand] = &[
    TypableCommand {
        ...
        fun: super::application::typed::exit,
    ...
    TypableCommand {
        ...
        fun: super::application::typed::force_exit,
        completer: CommandCompleter::positional(&[completers::filename]),
        signature: Signature {
            positionals: (0, Some(1)),
            flags: &[WRITE_NO_FORMAT_FLAG, WRITE_NO_CODE_ACTIONS_FLAG],
    ...
    TypableCommand {
        ...
        fun: super::application::typed::quit,
    ...
    TypableCommand {
        ...
        fun: super::application::typed::force_quit,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::buffers::typed::buffer_close,
    ...
    TypableCommand {
        ...
        fun: super::buffers::typed::force_buffer_close,
        completer: CommandCompleter::all(completers::buffer),
        signature: Signature {
            positionals: (0, None),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::buffers::typed::buffer_close_others,
        completer: CommandCompleter::none(),
    ...
    TypableCommand {
        ...
        fun: super::buffers::typed::force_buffer_close_others,
        completer: CommandCompleter::none(),
        signature: BUFFER_CLOSE_OTHERS_SIGNATURE,
    },
    TypableCommand {
        ...
        fun: super::buffers::typed::buffer_close_all,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::buffers::typed::force_buffer_close_all,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::buffers::typed::buffer_next,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::buffers::typed::buffer_previous,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::files::typed::force_write,
        completer: CommandCompleter::positional(&[completers::filename]),
        signature: Signature {
            positionals: (0, Some(1)),
            flags: &[WRITE_NO_FORMAT_FLAG,WRITE_NO_CODE_ACTIONS_FLAG],
    ...
    TypableCommand {
        ...
        fun: super::files::typed::write_buffer_close,
        completer: CommandCompleter::positional(&[completers::filename]),
        signature: Signature {
            positionals: (0, Some(1)),
            flags: &[WRITE_NO_FORMAT_FLAG,WRITE_NO_CODE_ACTIONS_FLAG],
    ...
    TypableCommand {
        ...
        fun: super::files::typed::force_write_buffer_close,
        completer: CommandCompleter::positional(&[completers::filename]),
        signature: Signature {
            positionals: (0, Some(1)),
            flags: &[WRITE_NO_FORMAT_FLAG,WRITE_NO_CODE_ACTIONS_FLAG],
    ...
    TypableCommand {
        ...
        fun: super::files::typed::new_file,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::formatting::typed::format,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::files::typed::set_indent_style,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(1)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::files::typed::set_line_ending,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(1)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::history::typed::earlier,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(1)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::application::typed::write_quit,
        completer: CommandCompleter::positional(&[completers::filename]),
        signature: Signature {
            positionals: (0, Some(1)),
            flags: &[WRITE_NO_FORMAT_FLAG, WRITE_NO_CODE_ACTIONS_FLAG],
    ...
    TypableCommand {
        ...
        fun: super::application::typed::force_write_quit,
        completer: CommandCompleter::positional(&[completers::filename]),
        signature: Signature {
            positionals: (0, Some(1)),
            flags: &[WRITE_NO_FORMAT_FLAG, WRITE_NO_CODE_ACTIONS_FLAG],
    ...
    TypableCommand {
        ...
        fun: super::files::typed::write_all,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            flags: &[WRITE_NO_FORMAT_FLAG, WRITE_NO_CODE_ACTIONS_FLAG],
    ...
    TypableCommand {
        ...
        fun: super::files::typed::force_write_all,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            flags: &[WRITE_NO_FORMAT_FLAG, WRITE_NO_CODE_ACTIONS_FLAG],
    ...
    TypableCommand {
        ...
        fun: super::application::typed::write_all_quit,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            flags: &[WRITE_NO_FORMAT_FLAG, WRITE_NO_CODE_ACTIONS_FLAG],
    ...
    TypableCommand {
        ...
        fun: super::application::typed::force_write_all_quit,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            flags: &[WRITE_NO_FORMAT_FLAG, WRITE_NO_CODE_ACTIONS_FLAG],
    ...
    TypableCommand {
        ...
        aliases: &["qa"],
        doc: "Close all views.",
        fun: super::application::typed::quit_all,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::application::typed::force_quit_all,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::application::typed::cquit,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(1)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::application::typed::force_cquit,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(1)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::registers::typed::yank_joined,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(1)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::registers::typed::yank_main_selection_to_clipboard,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::registers::typed::yank_joined_to_clipboard,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(1)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::registers::typed::yank_main_selection_to_primary_clipboard,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::registers::typed::yank_joined_to_primary_clipboard,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(1)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::registers::typed::paste_clipboard_after,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::registers::typed::paste_clipboard_before,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::registers::typed::replace_selections_with_clipboard,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::registers::typed::paste_primary_clipboard_after,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::registers::typed::paste_primary_clipboard_before,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::registers::typed::replace_selections_with_primary_clipboard,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::registers::typed::show_clipboard_provider,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::workspace::change_current_directory,
    ...
    TypableCommand {
        ...
        fun: super::workspace::show_directory_stack,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::workspace::push_directory,
        completer: CommandCompleter::positional(&[completers::directory]),
        signature: Signature {
            positionals: (1, Some(1)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::workspace::pop_directory,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::workspace::show_current_directory,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::files::typed::set_encoding,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(1)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::files::typed::get_character_info,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::files::typed::reload_all,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::lsp::typed::lsp_workspace_command,
    ...
    TypableCommand {
        ...
        fun: super::lsp::typed::lsp_restart,
    ...
    TypableCommand {
        ...
        fun: super::syntax::typed::tree_sitter_scopes,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::syntax::typed::tree_sitter_highlight_name,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::syntax::typed::tree_sitter_layers,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::dap::typed::debug_start,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, None),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::dap::typed::debug_remote,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, None),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::dap::typed::debug_eval,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (1, Some(1)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::windows::typed::vsplit,
        completer: CommandCompleter::all(completers::filename),
        signature: Signature {
            positionals: (0, None),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::windows::typed::vsplit_new,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::windows::typed::hsplit,
        completer: CommandCompleter::all(completers::filename),
        signature: Signature {
            positionals: (0, None),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::windows::typed::hsplit_new,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::navigation::typed::goto_line_number,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (1, Some(1)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::files::typed::language,
    ...
    TypableCommand {
        ...
        fun: super::spelling::typed::spelling_language,
    ...
    TypableCommand {
        ...
        fun: super::config::toggle_option,
        completer: CommandCompleter::positional(&[completers::setting]),
        signature: Signature {
            positionals: (1, None),
            raw_after: Some(1),
    ...
    TypableCommand {
        ...
        fun: super::editing::typed::reflow,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(1)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::syntax::typed::tree_sitter_subtree,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::config::refresh_config,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::config::open_workspace_config,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::application::typed::open_log,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::shell::typed::insert_output,
    ...
    TypableCommand {
        ...
        fun: super::shell::typed::append_output,
        completer: SHELL_COMPLETER,
        signature: SHELL_SIGNATURE,
    },
    TypableCommand {
    ...
    TypableCommand {
        ...
        fun: super::shell::typed::run_shell_command,
        completer: SHELL_COMPLETER,
        signature: SHELL_SIGNATURE,
    },
    TypableCommand {
        ...
        fun: super::vcs::typed::reset_diff_change,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::registers::typed::clear_register,
    ...
    TypableCommand {
        ...
        fun: super::registers::typed::set_register,
    ...
    TypableCommand {
        ...
        fun: super::application::typed::redraw,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, Some(0)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::files::typed::move_buffer,
        completer: CommandCompleter::positional(&[completers::filename]),
        signature: Signature {
            positionals: (1, Some(1)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::files::typed::force_move_buffer,
        completer: CommandCompleter::positional(&[completers::filename]),
        signature: Signature {
            positionals: (1, Some(1)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::diagnostics::typed::yank_diagnostic,
        completer: CommandCompleter::all(completers::register),
        signature: Signature {
            positionals: (0, Some(1)),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::application::typed::echo,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (1, None),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        aliases: &[],
        doc: "Does nothing.",
        fun: super::application::typed::noop,
        completer: CommandCompleter::none(),
        signature: Signature {
            positionals: (0, None),
            ..Signature::DEFAULT
    ...
    TypableCommand {
        ...
        fun: super::workspace::trust_workspace,
        completer: CommandCompleter::none(),
    ...
    TypableCommand {
        ...
        fun: super::workspace::untrust_workspace,
        completer: CommandCompleter::none(),
        signature: Signature { positionals: (0, None), ..Signature::DEFAULT },
    },
    TypableCommand {
        ...
        fun: super::workspace::exclude_workspace,
        completer: CommandCompleter::none(),
        signature: Signature { positionals: (0, None), ..Signature::DEFAULT },
    }
];
